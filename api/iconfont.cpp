...
void IconFont::setIcon(QLabel *lab, const QChar &str, quint32 size)
{
...
void IconFont::setIcon(QAbstractButton *btn, const QChar &str, quint32 size)
{
    iconFont.setPixelSize(size);
...
QPixmap IconFont::getPixmap(const QColor &color, const QChar &str, quint32 size,
...
void IconFont::setStyle(QWidget *widget, QList<QToolButton *> btns, QList<int> pixChar,
...
void IconFont::setStyle(QFrame *frame, QList<QToolButton *> btns, QList<int> pixChar,
                        quint32 iconSize, quint32 iconWidth, quint32 iconHeight,
                        const QString &normalBgColor, const QString &darkBgColor,
                        const QString &normalTextColor, const QString &darkTextColor)
{
